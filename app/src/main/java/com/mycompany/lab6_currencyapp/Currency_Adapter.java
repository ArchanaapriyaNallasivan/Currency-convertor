package com.mycompany.lab6_currencyapp;
...
public class Currency_Adapter extends ArrayAdapter<CurrencyItem> {
    private ArrayList<CurrencyItem> currencyList;
    public Currency_Adapter(Context context, int textViewResourceId, ArrayList<CurrencyItem> currencyList)
    {
